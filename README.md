...
|---|---|---|---|
| **Nguyễn Thành Vinh** | — | Leader & Full-Stack Engineer | Thiết kế core prompt phân tích span và sinh minimal fix, cấu hình gọi Gemini API thật, kiểm soát nhiệt độ và tính ổn định đầu ra. |
